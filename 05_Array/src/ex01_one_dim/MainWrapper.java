...
public class MainWrapper {
  ...
  */
     ...
     *     0(정수타입), 0.0(실수타입), false(boolean타입), null(참조타입)
     * 3. 배열 요소 호출방법
     *    배열명[인덱스]
     *    
     */
  ...
  public static void ex01() {
      ...
      // 배열요소 확인 - 5개 모두 a라고 부르지만 구분위해서 인덱스 정보 0부터 넣어서 사용가능 , 길이만큼 인덱스 사용가능
  ...
  */
   ...
   // 이제 더 이상 배열 a가 참조하던 0x 10000000 영역을 참조하는 변수가 없다. 
   // 0x1000000 영역의 메모리 누수가 발생한다.
   // 이런 영역을 C++ 같은 언어에서는 delete명령으로 개발자가 직접 메모리 공간을 해제해야 하지만, (해제 안하면 메모리 누수발생)
