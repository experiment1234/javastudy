...
public class Ex01_String {
  ...
  public static void ex03( ) {
    ...
    boolean isEqual3 = name1.equalsIgnoreCase(name3); //대소문자를 무시하고 문자열을 비교 
  ...
  public static void ex07() {
    ...
    //2. substring(int begin, int end) : 인덱스 begin 부터 end 이전까지 반환(begin <= 추출범위
  ...
  public static void ex08() {
    ...
    //indexOf 메소드
    // 1.특정 문자열의 인덱스를 반환
    // 2. 특정 문자열 2개 이상 존재하는 경우 발견된 첫 번째 문자열의 인덱스를 반환
    // 3. 발견되지 않으면 -1을 반환 
    
    // IndexOf 사용법
    // 1. indexOf(String str) : 인덱스 0부터 String str을 검색
    // 2. indexOf(String str, int index) : 인덱스 index 부터 String str을 검색
 ...
 // lastIndexOf 메소드
  ...
  public static void ex10() {
    ...
    //contains 메소드
    // 지정된 CharSequence(String, char[] 등)가 포함되어 있으면 ture반환, 아니면 false를 반환
  ...
  public static void ex11() {
    ...
    //isEmpty 메소드
    // 1. 빈 문자열이면 true반환, 아니면 false를 반환
  ...
  //isBank 메소드
  //1. 빈 문자열이나 공백 문자로 구성되어있다면 true 반환, 아니면 false 반환
  ...
  public static void ex12() {
    ...
    System.out.println(String.format("%o", number)); // %o : 8진수 표기법 
    System.out.println(String.format("%d", number)); // %d : 10진수 표기법 
    System.out.println(String.format("%x", number)); // %s : 16진수 표기법 (0~9, a~f)
    System.out.println(String.format("%X", number)); // %X : 16진수 표기법 (0~9, A~F)
