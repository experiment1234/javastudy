...
public class MainWrapper {
  ...
  public static void ex01() {
    ...
    try {
      ...
      String serviceKey = "p3hkU+9azvCOSCaNAFfUNq6F5C5KvkRg1bEnWOM+z2x++t2kHIgFsMQFOFWE4hZS6zRZ7tUHKF7g9dWMpXcWUA==";
      ...
      sb.append(spec);
      sb.append("?serviceKey=").append(URLEncoder.encode(serviceKey, "UTF-8"));  // UnsuppUortedEncodingException
