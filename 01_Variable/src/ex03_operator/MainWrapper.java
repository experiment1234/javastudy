...
public class MainWrapper {
  ...
  public static void ex01() {
    ...
    double result = (double) i / j; // 5.0/ 2 -> 5.0 / 2.0(자바가 알아서 바뀜)
  ...
  // ex02 메소드 정의
    ...
    public static void ex03() {
      ...
      boolean result6 = a != b; // a와 b가 다르면 true, 아니면(같으면) false
    ...
    boolean andResult = (x == 10) && (y == 10);   // 모든 조건이 만족하지 않기 때문에 false나옴
    ...
    // 1. 논리 AND : 결과가 false인 조건이 나타나면 더 이상 조건을 체크하지 않는다. 최종 결과는 false로 정해졌기 때문이다. 
    // 2. 논리 OR  : 결과가 true인  조건이 나타나면 더 이상 조건을 체크하지 않는다. 최종 결과는 true로 정해졌기 때문이다. 
    int i = 10;
    int j = 10;
