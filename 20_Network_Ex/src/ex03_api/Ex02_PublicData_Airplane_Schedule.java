...
public class Ex02_PublicData_Airplane_Schedule {
  ...
  public static void ex01() {
    ...
    BufferedReader reader = null; //응답 데이터를 읽는 입력스트림
  ...
  public static void ex02() {
   ...
   try {
    ...
    //body의 4번째 자식 노드
     Node totalCount = bodyChild.item(3);            // <totalCount>1</totalCount>
     System.out.println(totalCount.getNodeName());   // totalCount
     System.out.println(totalCount.getTextContent());// 1
