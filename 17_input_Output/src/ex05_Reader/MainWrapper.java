...
public class MainWrapper {
    ...
    public static void ex01() {
      ...
      try {
        //파일입력스트림 생성(반드시 예외처리 필요, 파일이 없으면 FileNotFoundException 발생)
    ...
    public static void ex02() {
      ...
      try {
        ...
        // 2. 실제로 읽은 글자수를 반환한다. 
        // 3. 읽은 문자가 없으면 -1를 반환한다. 
        
        // 반복문 : read()의 반환값이 -1이 아니면 계속 읽는다.
        while((readChar = fr.read(cubf)) != -1) {
          sb.append(cubf, 0, readChar);
        // 배열 cbuf의 인덱스 0부터 readChar개 문자 sb에 추가한다. 
        }
    ...
    public static void ex03() {
      ...
      try {
        //버퍼입력스트림 생성(반드시 예외처리 필요, 파일이 없으면 FileNotFoundException 발생)
