...
public class MainWrapper {
    ...
    /*
     * throws 
     * 1.메소드에서 발생하는 모든 예외를 던질때 사용한다.
     * 2.메소드 내부에서 try-catch를 처리하지 않고, 메소드를 호출하는 곳으로 예외를 던질때 사용한다. 
     * 3.메소드를 호출하는 곳에서 try-catch를 처리한다. 
     */
  //print 메소드 정의
  //throws.NullPointerException : 메소드를 호출할때 NullPointerException 처리가 필요하다
