 ...
 * 3. protected : 동일한 패키지 or (패키지가 달라도) 다른 패키지에 있는 상속 관계의 클래스 
 ...
 * 3. Java에서는 정보 은닉을 위해서 필드는 private처리하고 , 메소드는 public 처리한다.
 * 4. Java에서는 필드에 접근하기 위해서는 메소드를 통해서 접근한다(필드에 직접 접근할 수 없다)
 */
